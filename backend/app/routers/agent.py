...
if (-not $admin) { throw "Bitte in einer PowerShell mit Administratorrechten ausführen." }
...
Invoke-WebRequest -UseBasicParsing -Uri "$Server/api/agent/setup/download/windows-amd64?token=$Token" -OutFile $exe
